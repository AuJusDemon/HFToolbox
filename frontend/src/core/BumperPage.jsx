        ...
        <div className="card-body">
          ...
          {tab==='log' && (
            log.length===0
              ...
              : <>
                  <div className="bl-tbl-hdr" style={{display:'grid',gridTemplateColumns:'58px 1fr 90px 54px',gap:8,padding:'0 0 6px',borderBottom:'1px solid var(--b1)',marginBottom:2}}>
                  ...
                  {log.slice(0,60).map(entry => (
                    <div key={entry.id} className="bl-tbl-row" style={{display:'grid',gridTemplateColumns:'58px 1fr 90px 54px',gap:8,alignItems:'center',padding:'5px 0',borderBottom:'1px solid rgba(21,30,46,.5)'}}>
