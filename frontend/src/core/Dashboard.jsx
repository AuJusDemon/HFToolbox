        ...
        {jobs.length === 0 ? (
          ...
          <>
            ...
            {visible.map(job => {
              ...
              return (
                <div key={job.id} className="db-bump-row" style={{
  ...
  return (
    <div className="card" style={{cursor:'pointer',height:420,display:'flex',flexDirection:'column'}} onClick={() => nav('/dashboard/contracts')}>
      ...
      <div className="card-body" style={{flex:1,display:'flex',flexDirection:'column',minHeight:0}}>
        ...
        {/* Column labels */}
        {contracts.length > 0 && (
          <div className="db-ctr-hdr" style={{display:'grid',gridTemplateColumns:'6px 56px 80px 1fr 52px',gap:8,padding:'0 0 5px',borderBottom:'1px solid var(--b1)',marginBottom:2,flexShrink:0}}>
            <span/>
          ...
          : contracts.length === 0
            ...
            : <div style={{display:'flex',flexDirection:'column',flex:1}}>
                {contracts.map(c => {
                  ...
                  return (
                    <div key={c.cid} className="db-ctr-row" style={{flex:1,display:'grid',gridTemplateColumns:'6px 56px 80px 1fr 52px',gap:8,alignItems:'center',borderBottom:'1px solid rgba(21,30,46,.4)'}}>
