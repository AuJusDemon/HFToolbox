...
const GROUP_STYLES = {
  ...
  "46": {color:"#222",fontFamily:"\"Amarante\",serif",fontWeight:"bold",
          textShadow:"-1px -1px 0 #0f0,1px -1px 0 #0f0,-1px 1px 0 #0f0,1px 1px 0 #0f0,0 0 5px #0f0,0 0 10px #0f0,0 0 15px #080"},
  "48": {color:"#dfcbff",fontFamily:"\"New Rocker\",system-ui",fontWeight:"bold",letterSpacing:"1.75px",
          textShadow:"0 0 1px #b380ff,0 0 3px #9933ff,0 0 6px #7722cc,0 0 12px #550099"},
  "50": {fontWeight:"700",fontFamily:"\"Cinzel\",serif",letterSpacing:"2px",
          background:"linear-gradient(135deg,#FFD700,#FFC200,#B8860B)",
          WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"},
  "52": {color:"#FF99CC",fontFamily:"\"Comic Sans MS\",cursive",fontWeight:"bold",
          textShadow:"2px 2px 2px #4020dd"},
  "68": {fontFamily:"\"Cinzel\",serif",fontWeight:"900",letterSpacing:"1.15px",
          background:"linear-gradient(90deg,#9a9a9a 0%,#cfcfcf 20%,#fff 35%,#fff 45%,#e6e6e6 55%,#cfcfcf 70%,#9a9a9a 100%)",
          backgroundSize:"300% auto",animation:"brotherhood-shine 4s ease-in-out infinite",
          WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"},
  "70": {color:"#ff54a1",fontWeight:"bold",textShadow:"2px 2px 2px #000"},
  "71": {color:"#00feb0",textShadow:"0 2px 3px #000"},
  "77": {color:"#fff",fontFamily:"Graduate,sans-serif",letterSpacing:"2px",
          textShadow:"-1px -1px 0 #467fff,1px -1px 0 #098ed9,-1px 1px 0 #1199df,1px 1px 0 #139add,0 0 5px #529ec0,0 0 10px #56cad8,0 0 15px #4abfd6"},
  "78": {display:"inline-block",fontFamily:"\"Orbitron\",\"Cinzel\",serif",fontWeight:"900",
          letterSpacing:"1.15px",
          background:"linear-gradient(90deg,#00ffb2 0%,#00e6ff 35%,#b7fff1 50%,#00e6ff 65%,#00ffb2 100%)",
          WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",
          animation:"vibe-glitch 3.5s infinite"},
  "7":  {color:"#ccc",textDecoration:"line-through"},
  "38": {color:"#ccc",textDecoration:"line-through"},
}
function groupStyle(gid) {
  return GROUP_STYLES[gid] || {color:"var(--sub)"}
}
      ...
      <div className="shell">
        ...
        <aside className="sidebar">
          <div className="sb-inner">
              ...
              <div style={{display:'flex',alignItems:'center',gap:9,marginBottom:7}}>
                ...
                <div style={{minWidth:0}}>
                  ...
                  <div className="sb-pills">
                    {displayGid && (
                      <span style={{fontSize:10,...groupStyle(displayGid)}}>{GROUPS[displayGid]}</span>
                    )}
                  </div>
                </div>
              </div>
            ...
            <NavLink to="/dashboard/merchant" label="Merchant HQ" />
...
function MobileNav() {
  ...
  const items = [
    ...
    { to:'/dashboard/merchant', label:'MERCH'    },
