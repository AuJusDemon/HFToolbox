    ...
    <div style={{ display:'flex', flexDirection:'column', gap:12 }}>

      {
        <div style={{ display:'flex', flexDirection:'column', gap:12 }}>
          ...
          {/* Stats bar — 6 tiles */}
          <div className="ctr-stats-bar" style={{
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              {/* Column headers */}
              <div className="ctr-tbl-hdr" style={{ display:'grid', gridTemplateColumns:'58px 108px 90px 1fr 72px 88px', gap:8, padding:'0 8px 6px', borderBottom:'1px solid var(--b1)', marginBottom:2 }}>
